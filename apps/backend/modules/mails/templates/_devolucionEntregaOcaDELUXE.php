...
<p>
	...
	<a style="color:#FD7977;" href="<?php echo sfConfig::get('app_host'); ?>/devoluciones/<?php echo $devolucion->getIdDevolucion(); ?>/imprimir-etiqueta">Hacé click para visualizar etiqueta</a>
    <br /><br />
