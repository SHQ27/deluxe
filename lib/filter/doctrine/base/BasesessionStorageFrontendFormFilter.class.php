...
/**
 * sessionStorageFrontend filter form base class.
 *
 * @package    deluxebuys
 * @subpackage filter
 ...
 */
abstract class BasesessionStorageFrontendFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('session_storage_frontend_filters[%s]');
