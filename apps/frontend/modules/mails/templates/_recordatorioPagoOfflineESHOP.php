...
<p>	
    ...
    <br /><br />
    Si cambiaste de opinion y ya no querés pagar tu pedido, por favor hacé <a style="color:<?php echo $eshop->getLinkColor(); ?>; font-weight: bold;" href="http://<?php echo $eshop->getDominio() . '/pedido/aviso/' . $hash . '/bajaRecordatorioOffline'; ?>">click aquí</a>, de esta manera otros usuarios pueden disponer de los articulos que seleccionaste previamente.
	<br /><br />
