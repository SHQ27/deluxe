...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="es" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]-->
    ...
    <head>    
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo sfConfig::get('app_host_static'); ?>/css/eshop/<?php echo $file . '?v=' . cacheHelper::getInstance()->getStaticVersion(); ?>" />
        <?php endforeach; ?>
        
        <link rel="stylesheet" type="text/css" href="<?php echo sfConfig::get('app_host_static'); ?>/css/eshop/adaptaciones/<?php echo $eshop->getIdEshop() . '.css?v=' . cacheHelper::getInstance()->getStaticVersion(); ?>" />
    	...
    	<script>
            var useMenuFlotante =  <?php echo ( $eshop->getUsaMenuFlotante() )? 'true' : 'false'; ?>;
    ...
    <body>
        ...
        <div class="barraFlotante">
            <div class="container">
                <a class="logo" href="<?php echo url_for('homepage'); ?>"></a>
       ...
       <div class="header">
            ...
            <section class="seccion OS" id="toolbar_up">
            	<div class="container">
                    <div class="items inline">
                        <a class="item inline tiendas" href="<?php echo url_for('tiendas'); ?>"><?php echo $eshop->getTiendasTitulo(); ?></a>
                        <a class="item inline comoComprar lIzq" href="<?php echo url_for('consultas_como_comprar'); ?>">Como Comprar</a>
                        <a id="btConsultas" class="item inline lIzq" href="<?php echo url_for('consultas'); ?>">Consultas</a>
                    </div>

                    <div class="mensaje-central inline">
                        <strong>Free shipping a partir de $<?php echo $eshop->getFreeshipping(); ?></strong>
                    </div>
            		...
            		<div class="items derecha">
        				...
        				<div id="nologged">
                             <a class="item inline lIzq bold signin" href="<?php echo url_for('usuario'); ?>">REGISTRARSE</a>
                			 <a class="item inline lIzq semiBold login" href="<?php echo url_for('usuario'); ?>"><?php echo $eshop->getTextoIniciarSesion(); ?></a>
            			 </div>
    					<?php else: ?>
    					
    					<?php $usuario = $sf_user->getCurrentUser();?>
                        <div id="logged">
            				<a class="item OS-11 bold inline lIzq btMiCuenta" href="#" id="btMiCuenta" rel="header"><strong><?php echo $usuario->getNombre(); ?></strong></a>

                            <div id="d-micuenta" class="desplegable">
                            	<span class="arrow"></span>
                            	
                            	<div class="link"><a href="<?php echo url_for('mi_cuenta'); ?>" class="OS-11 color2">Mi Cuenta</a></div>
                            	<div class="link"><a id="btLogout" href="<?php echo url_for('logout'); ?>" class="OS-11 color2">Cerrar Sesión</a></div>
            ...
            <div class="main-header">
                <section id="logoCont" class="seccion blanco">
                	<div class="container">
                		<div class="logo"><a href="<?php echo url_for('homepage'); ?>"></a></div>
                	</div>
                </section>
