...
class libroIvaVentaForm extends sfFormSymfony
{
  	...
  	{  		
      	...
      	$this->getWidgetSchema()->setNameFormat('libroIvaVentaForm[%s]');
  	}
  	...
  	public function process()
  	{
        ...
        $idUsuario = sfContext::getInstance()->getUser()->getGuardUser()->getId();
  	    ...
  	    $task = new Net_Gearman_Task ('LibroIvaVentaWorker', array ('idUsuario' => $idUsuario, 'periodo' => $periodo) );
