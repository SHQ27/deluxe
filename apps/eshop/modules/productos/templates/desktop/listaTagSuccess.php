...
<section id="productos" class="seccion blanco">
	<div class="container">
        ...
        <div class="banner-listado">
            <img src="<?php echo  imageHelper::getInstance()->getUrl('eshop_banner_listado', $eshop); ?>" />
        </div>
        <?php endif; ?>
		...
		<div class="pantalla">
            ...
            <?php 
            	include_component(
            		...
            		'filter', 
            		array(
            			'filters'  => array('tag' => $queryTag, 'rango' => $rango, 'idEshop' => $idEshop),
            			'query'    => $query
            		)
            	);
            ?>
			...
			<div class="muestra inline">
				<div class="barra OS-11 lh16 color2">
					<div class="izquierda">Inicio > <span class="bold titleTag"><?php echo ucwords($queryTag)?></span></div>
					<div class="derecha">
						<div class="cantidad-modelos">
                            <span class="bold"><?php echo $pager->getNumResults(); ?> <?php echo ngettext( 'MODELO', 'MODELOS', $pager->getNumResults())?></span> PARA VOS!
                        </div>
