...
{
    static protected $metadata = array();
     
    static public function addMetadata($key, $value)
    {
        self::$metadata[$key] = $value;
    }
    
    static public function setMetadata(array $metadata)
    {
    ...
    static public function register(Zend_Service_Amazon_S3 $s3, $name = 's3')
    {
        stream_register_wrapper($name, 'S3StreamWrapper');
        $s3->registerAsClient($name);       
    }
    ...
    public function stream_flush()
    {
        ...
        $ret = $this->_s3->putObject($this->_objectName, $this->_objectBuffer, self::getMetadata());
    ...
    /*  All the code from here is copied from Zend_Service_Amazon_S3_Stream */
