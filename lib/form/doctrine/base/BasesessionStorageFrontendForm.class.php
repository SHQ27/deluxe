...
/**
 * sessionStorageFrontend form base class.
 *
 * @method sessionStorageFrontend getObject() Returns the current form's model object
 *
 * @package    deluxebuys
 * @subpackage form
 ...
 */
abstract class BasesessionStorageFrontendForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('session_storage_frontend[%s]');
