...
<p>
    ...
    <br />
    <br /> Te informamos que se ha procesado correctamente tu pago del
    pedido <strong>#<?php echo $pedido->getIdPedido() ?></strong> <br />
    Una vez enviado, recibirás un mail con las indicaciones para poder
    ver online el estado del pedido de entrega. <br />
    <br /> <strong>DETALLE DE TU PEDIDO</strong>
</p>

<table
    style="font-family: Trebuchet MS, Helvetica, sans-serif; color: #333; font-size: 12px; line-height: 25px;"
    width="550px" cellpadding="10" cellspacing="0" border="0">
    <thead>
        <tr>
...
<p>	
	...
	<br /> <strong>Total:</strong> $<?php echo formatHelper::getInstance()->decimalNumber( $pedido->getMontoTotal() ); ?>
