...
<?php if ( $status ): ?>
<p class="ok">
    El proceso de edición de precios y stock finalizó correctamente.
    <br /><br />
...
<table>
    <?php foreach ($productos as $producto):?>
        ...
        <tr>
            ...
            <td class="center"><?php echo $productoItem->getStockOutlet(); ?></td>
...
<p class="ko">
    El proceso de edición de precios y stock no se pudo realizar pues el CSV contenía con los siguientes errores
</p>
